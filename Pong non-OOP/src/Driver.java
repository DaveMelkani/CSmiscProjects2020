 ...
 * PLZ
 * 
 * paddles get stuck past boundaries sometimes but it gets out eventually, other than that, good game -tarrega
 * number in middle distracts me
 * paddles bounce off edges sometimes, resulting in direction keys to do the opposite of what they did
 * Nice graphics, but ball gets glitched when it hits the side of the paddle, and scores on itself
 * great game, but the balll gets stuck behind the paddle, paddle goes of the screen
 * fun, paddles go off screen, ball gets stuck behind paddle, but i like your font :)
 * I really like the font, very different but paddles go off screen and ball sometimes spazzes when it hits the top or bottom of a paddle
 * paddles shouldnt go off screen
